...
if (BUILD_OPTIMIZERS)
    list(APPEND SIMBODY_DIRS ${CMAKE_SOURCE_DIR}/Simbody01/SimTKmath/Optimizers/src)
    list(APPEND SIMBODY_DIRS ${CMAKE_SOURCE_DIR}/Simbody01/SimTKmath/Optimizers/src/IpOpt)
    list(APPEND SIMBODY_DIRS ${CMAKE_SOURCE_DIR}/Simbody01/SimTKmath/Optimizers/src/c-cmaes)
endif()

if (BUILD_GEOMETRY)
    list(APPEND SIMBODY_DIRS ${CMAKE_SOURCE_DIR}/Simbody01/SimTKcommon/Polynomial/include)
    list(APPEND SIMBODY_DIRS ${CMAKE_SOURCE_DIR}/Simbody01/SimTKcommon/Polynomial/include/SimTKcommon/internal)
    list(APPEND SIMBODY_DIRS ${CMAKE_SOURCE_DIR}/Simbody01/SimTKcommon/Polynomial/src)

    list(APPEND SIMBODY_DIRS ${CMAKE_SOURCE_DIR}/Simbody01/SimTKcommon/Geometry/include)
    list(APPEND SIMBODY_DIRS ${CMAKE_SOURCE_DIR}/Simbody01/SimTKcommon/Geometry/include/SimTKcommon/internal)
    list(APPEND SIMBODY_DIRS ${CMAKE_SOURCE_DIR}/Simbody01/SimTKcommon/Geometry/src)

    list(APPEND SIMBODY_DIRS ${CMAKE_SOURCE_DIR}/Simbody01/SimTKmath/Geometry/include)
    list(APPEND SIMBODY_DIRS ${CMAKE_SOURCE_DIR}/Simbody01/SimTKmath/Geometry/include/simmath/internal)
    list(APPEND SIMBODY_DIRS ${CMAKE_SOURCE_DIR}/Simbody01/SimTKmath/Geometry/src)
endif()

IF (BUILD_RANDOM)
    list(APPEND SIMBODY_DIRS ${CMAKE_SOURCE_DIR}/Simbody01/SimTKcommon/Random/include)
    list(APPEND SIMBODY_DIRS ${CMAKE_SOURCE_DIR}/Simbody01/SimTKcommon/Random/include/SimTKcommon/internal)
    list(APPEND SIMBODY_DIRS ${CMAKE_SOURCE_DIR}/Simbody01/SimTKcommon/Random/src)
ENDIF()

IF (BUILD_CPODES)
    list(APPEND SIMBODY_DIRS ${CMAKE_SOURCE_DIR}/Simbody01/SimTKmath/Integrators/src/CPodes)
    list(APPEND SIMBODY_DIRS ${CMAKE_SOURCE_DIR}/Simbody01/SimTKmath/Integrators/src/CPodes/sundials/include)
    list(APPEND SIMBODY_DIRS ${CMAKE_SOURCE_DIR}/Simbody01/SimTKmath/Integrators/src/CPodes/sundials/include/cpodes)
    list(APPEND SIMBODY_DIRS ${CMAKE_SOURCE_DIR}/Simbody01/SimTKmath/Integrators/src/CPodes/sundials/include/nvector)
    list(APPEND SIMBODY_DIRS ${CMAKE_SOURCE_DIR}/Simbody01/SimTKmath/Integrators/src/CPodes/sundials/include/sundials)
    list(APPEND SIMBODY_DIRS ${CMAKE_SOURCE_DIR}/Simbody01/SimTKmath/Integrators/src/CPodes/sundials/src/cpodes)
    list(APPEND SIMBODY_DIRS ${CMAKE_SOURCE_DIR}/Simbody01/SimTKmath/Integrators/src/CPodes/sundials/src/nvector)
    list(APPEND SIMBODY_DIRS ${CMAKE_SOURCE_DIR}/Simbody01/SimTKmath/Integrators/src/CPodes/sundials/src/sundials)
ENDIF()
...
# # print all includes
# message(STATUS "SIMBODY_SOURCE_INCLUDE_FILES:")
# foreach(file ${SIMBODY_SOURCE_INCLUDE_FILES})
#     message(STATUS "  ${file}")
# endforeach()

# message(STATUS "SIMBODY_SOURCE_CXX_FILES:")
# foreach(file ${SIMBODY_SOURCE_CXX_FILES})
#     message(STATUS "  ${file}")
# endforeach()
...
set_source_files_properties(${SIMBODY_SOURCE_C_FILES}
PROPERTIES COMPILE_DEFINITIONS "${SIMBODY_COMMON_DEFS}"
)
set_source_files_properties(${SIMBODY_SOURCE_CXX_FILES}
PROPERTIES COMPILE_DEFINITIONS "${SIMBODY_COMMON_DEFS}"
)
set_source_files_properties(${SIMBODY_SOURCE_INCLUDE_FILES}
    PROPERTIES COMPILE_DEFINITIONS "${SIMBODY_COMMON_DEFS}"
)
