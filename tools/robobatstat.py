...
class BATCorrelations:
    def __init__(self, prmtop_file, inpcrd_file, seed, include_omega=False, include_chi1=True, include_chi2=True, include_chi3=True, include_chi4=True, include_chi5=True):
