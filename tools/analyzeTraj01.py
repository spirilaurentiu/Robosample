...
parser.add_argument(
    "--bse", action="store_true", default=False, help="Use block averaging"
)
parser.add_argument(
    "--nofAddMethods",
    default=0,
...
parser.add_argument(
    "--logDiffWin", default=3, type=int, help="Moving difference window."
)
parser.add_argument(
    "--trajDiffWin", default=3, type=int, help="Moving difference window."
)
parser.add_argument("--accMAWin", default=3, type=int, help="Moving average window.")
parser.add_argument(
    "--accDiffWin", default=3, type=int, help="Moving difference window."
)
...
if "traj" in args.analyze:
    ...
    for paramSeti in range(nofParamSets):
        ...
        for simi in range(startSim, nofSimsPerParamSet + startSim):
            ...
            axs[1].errorbar(
                X, Y, yerr=Yerr, color=colors[paramSeti], errorevery=100, elinewidth=0.5
            )
