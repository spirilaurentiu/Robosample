...
# system = prmtop.createSystem(nonbondedMethod=app.CutoffNonPeriodic, nonbondedCutoff=1.2, constraints=None, implicitSolvent=app.OBC2, removeCMMotion=False)
...
# Backbone dihedral bond between atom ALA1_CA_5 (global index 3) and atom ALA1_C_11 (global index 1)
# Backbone dihedral bond between atom ALA1_C_11 (global index 1) and atom ALA2_N_13 (global index 2)


# mbIx  invalid  q            u            qdot         udot         qddot        atoms
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# 1              []           []           []           []           []           [ALA1_O_12_ROOT, ALA1_C_11]
# 2              [+0.00e+00]  [+0.00e+00]  [+0.00e+00]  [-4.44e-01]  [-4.44e-01]  [ALA2_N_13, ALA2_CA_15, ALA2_H_14, ALA2_CB_17, ALA2_C_21, ALA2_HA_16, ALA2_HB1_18, ALA2_HB2_19, ALA2_HB3_20, ALA2_O_22, ALA2_OXT_23]
# 3              [+0.00e+00]  [+0.00e+00]  [+0.00e+00]  [-1.19e+01]  [-1.19e+01]  [ALA1_CA_5, ALA1_CB_7, ALA1_N_1, ALA1_HA_6, ALA1_HB1_8, ALA1_HB2_9, ALA1_HB3_10, ALA1_H1_2, ALA1_H2_3, ALA1_H3_4]
...
bonds = context.getDefaultBonds('rama') # [[atom1, atom2, joint_type], [atom3, atom4, joint_type], ...]
