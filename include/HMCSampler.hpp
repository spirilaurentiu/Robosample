...
public:
	...
	const EnergySnapshot& getPreviousEnergy() const { return previousEnergy; }
	const EnergySnapshot& getCurrentEnergy() const { return currentEnergy; }
	...
	*/
	...
	void useFixmanPotential(void) { useFixman = true; }
	bool isUsingFixmanPotential(void) const { return useFixman; }
	...
	virtual void perturbVelocities(SimTK::State& someState, VelocitiesPerturbMethod VPM = VelocitiesPerturbMethod::TO_T);
	...
	*/
	...
	void getMsg_EnergyDetails(std::stringstream& ss, const SimTK::State& someState, bool isTheSampleValid, bool isTheSampleAccepted);
