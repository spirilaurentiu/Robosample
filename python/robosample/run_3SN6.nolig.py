"""Per-body force monitoring for 3SN6 (human beta2-AR) WITHOUT agonist (apo), in a nanodisc.
...
Run from the repo root:
    python3 python/robosample/run_3SN6.nolig.py
"""
...
NAME = "3SN6.noLig"
PRMTOP = "examples/febs/3SN6.noLig.nanodisc.prmtop"
INPCRD = "examples/febs/3SN6.noLig.nanodisc.min.rst7"
