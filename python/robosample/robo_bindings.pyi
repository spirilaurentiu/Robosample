...
__all__: list[str] = [
    ...
    "World",
    "ZMatrixRow",
    "align_flip_and_translate_frame_along_x_axis",
    "calculate_angle_in_rad",
    "calculate_dihedral_in_rad",
    "calculate_log_sum_exp2",
    "calculate_mag_sq",
    "chirality_from_plane_deviation",
    "exceeds_planarity_threshold",
    "flipped_chirality",
    "is_bond_chirality_mismatch",
    "is_chirality_mismatch",
    "multiply_by_scalar",
    "normalize_in_place",
    "plane_normal",
    "resolve_reference_indices",
    "safe_log_sine_sqr",
    "signed_plane_deviation",
    "triple_product",
]
...
class AcceptRejectMode:
    ...
    AlwaysAccept: typing.ClassVar[
        AcceptRejectMode
    ]  # value = <AcceptRejectMode.AlwaysAccept: 0>
    MetropolisHastings: typing.ClassVar[
        AcceptRejectMode
    ]  # value = <AcceptRejectMode.MetropolisHastings: 1>
    __members__: typing.ClassVar[
        dict[str, AcceptRejectMode]
    ]  # value = {'AlwaysAccept': <AcceptRejectMode.AlwaysAccept: 0>, 'MetropolisHastings': <AcceptRejectMode.MetropolisHastings: 1>}
    @typing.overload
...
class BondCenterChirality:
    ...
    LeftHanded: typing.ClassVar[
        BondCenterChirality
    ]  # value = <BondCenterChirality.LeftHanded: 1>
    Planar: typing.ClassVar[
        BondCenterChirality
    ]  # value = <BondCenterChirality.Planar: 2>
    RightHanded: typing.ClassVar[
        BondCenterChirality
    ]  # value = <BondCenterChirality.RightHanded: 0>
    __members__: typing.ClassVar[
        dict[str, BondCenterChirality]
    ]  # value = {'RightHanded': <BondCenterChirality.RightHanded: 0>, 'LeftHanded': <BondCenterChirality.LeftHanded: 1>, 'Planar': <BondCenterChirality.Planar: 2>}
    @typing.overload
...
class BondMobility:
    ...
    LineOrientationF: typing.ClassVar[
        BondMobility
    ]  # value = <BondMobility.LineOrientationF: 9>
    LineOrientationM: typing.ClassVar[
        BondMobility
    ]  # value = <BondMobility.LineOrientationM: 10>
    OrthoSpherical: typing.ClassVar[
        BondMobility
    ]  # value = <BondMobility.OrthoSpherical: 16>
...
class Context:
    ...
    def __init__(
        ...
        arg6: typing.SupportsInt | typing.SupportsIndex,
        arg7: bool,
    ) -> None: ...
    ...
    def addThermodynamicState(
        ...
        arg1: collections.abc.Sequence[AcceptRejectMode],
        arg2: collections.abc.Sequence[typing.SupportsInt | typing.SupportsIndex],
        arg3: collections.abc.Sequence[str],
        arg4: collections.abc.Sequence[typing.SupportsInt | typing.SupportsIndex],
        arg5: collections.abc.Sequence[typing.SupportsInt | typing.SupportsIndex],
        arg6: collections.abc.Sequence[IntegratorType],
        arg7: collections.abc.Sequence[typing.SupportsInt | typing.SupportsIndex],
        arg8: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex],
        arg9: collections.abc.Sequence[typing.SupportsInt | typing.SupportsIndex],
    ) -> None:
        """
    ...
    def add_world(
        ...
        arg1: typing.SupportsInt | typing.SupportsIndex,
        arg2: RootMobility,
        arg3: collections.abc.Sequence[collections.abc.Sequence[BondFlexibility]],
    ) -> None:
        """
        Add an empty world.
        """
    def calculate_openmm_energy(
        self, worldIndex: typing.SupportsInt | typing.SupportsIndex
    ) -> float:
        """
        Calculate the OpenMM energy of the current state for a specific world index.
        """
    def getAtomNameByPrmtopIndex(
        self, prmtopIndex: typing.SupportsInt | typing.SupportsIndex
    ) -> str:
        """
    ...
    def initialize_openmm(
        self,
        arg0: collections.abc.Sequence[RoboAtom],
        arg1: collections.abc.Sequence[RoboBond],
        arg2: collections.abc.Sequence[RoboAngle],
        arg3: collections.abc.Sequence[RoboPeriodicTorsion],
        arg4: collections.abc.Sequence[RoboHarmonicImproperTorsion],
        arg5: collections.abc.Sequence[CMAPGrid],
        arg6: collections.abc.Sequence[CMAPTorsion],
        arg7: collections.abc.Sequence[UreyBradley],
        arg8: bool,
        arg9: typing.SupportsInt | typing.SupportsIndex,
        arg10: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex],
        arg11: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex],
        arg12: collections.abc.Sequence[Exclusion],
        arg13: collections.abc.Sequence[Scaling14],
    ) -> bool:
        """
    ...
    def loadAmberSystem(
        self,
        arg0: collections.abc.Sequence[typing.SupportsInt | typing.SupportsIndex],
        arg1: collections.abc.Sequence[RoboAtom],
        arg2: collections.abc.Sequence[RoboBond],
        arg3: collections.abc.Sequence[RoboAngle],
        arg4: collections.abc.Sequence[RoboPeriodicTorsion],
        arg5: collections.abc.Sequence[RoboHarmonicImproperTorsion],
        arg6: collections.abc.Sequence[TopologyRange],
        arg7: collections.abc.Sequence[ZMatrixRow],
    ) -> None:
        """
    ...
    def setGBSAOptions(
        ...
        """
    def setNonbonded(
        self, arg0: NonbondedMethod, arg1: typing.SupportsFloat | typing.SupportsIndex
    ) -> None:
        """
        Set nonbonded method and cutoff.
        """
    def setPdbRestartFreq(
...
class Exclusion:
    ...
    def __init__(
        self,
        a1: typing.SupportsInt | typing.SupportsIndex,
        a2: typing.SupportsInt | typing.SupportsIndex,
    ) -> None: ...
    @property
    def a1(self) -> int: ...
    @a1.setter
...
class IntegratorType:
    ...
    BENDSTRETCH: typing.ClassVar[
        IntegratorType
    ]  # value = <IntegratorType.BENDSTRETCH: 9>
    BOUND_HMC: typing.ClassVar[IntegratorType]  # value = <IntegratorType.BOUND_HMC: 12>
    BOUND_WALK: typing.ClassVar[
        IntegratorType
    ]  # value = <IntegratorType.BOUND_WALK: 11>
    ...
    NOF_INTEGRATORS: typing.ClassVar[
        IntegratorType
    ]  # value = <IntegratorType.NOF_INTEGRATORS: 14>
    OMMVV: typing.ClassVar[IntegratorType]  # value = <IntegratorType.OMMVV: 10>
    RUNGEKUTTA: typing.ClassVar[
        IntegratorType
    ]  # value = <IntegratorType.RUNGEKUTTA: 5>
    RUNGEKUTTA2: typing.ClassVar[
        IntegratorType
    ]  # value = <IntegratorType.RUNGEKUTTA2: 6>
    RUNGEKUTTA3: typing.ClassVar[
        IntegratorType
    ]  # value = <IntegratorType.RUNGEKUTTA3: 7>
    RUNGEKUTTAFELDBERG: typing.ClassVar[
        IntegratorType
    ]  # value = <IntegratorType.RUNGEKUTTAFELDBERG: 8>
    STATIONS_TASK: typing.ClassVar[
        IntegratorType
    ]  # value = <IntegratorType.STATIONS_TASK: 13>
    VERLET: typing.ClassVar[IntegratorType]  # value = <IntegratorType.VERLET: 1>
    __members__: typing.ClassVar[
        dict[str, IntegratorType]
...
class NonbondedMethod:
    ...
    CutoffNonPeriodic: typing.ClassVar[
        NonbondedMethod
    ]  # value = <NonbondedMethod.CutoffNonPeriodic: 1>
    NoCutoff: typing.ClassVar[NonbondedMethod]  # value = <NonbondedMethod.NoCutoff: 0>
    __members__: typing.ClassVar[
        dict[str, NonbondedMethod]
    ]  # value = {'NoCutoff': <NonbondedMethod.NoCutoff: 0>, 'CutoffNonPeriodic': <NonbondedMethod.CutoffNonPeriodic: 1>}
    @typing.overload
...
class ReferenceIndices:
    def __init__(
        self,
        zero: typing.SupportsInt | typing.SupportsIndex,
        one: typing.SupportsInt | typing.SupportsIndex,
        two: typing.SupportsInt | typing.SupportsIndex,
    ) -> None: ...
    @property
    def one(self) -> int: ...
    @one.setter
...
class RoboAngle:
    def __init__(
        self,
        global_indices: typing.Annotated[
            collections.abc.Sequence[typing.SupportsInt | typing.SupportsIndex],
            "FixedSize(3)",
        ],
        prmtop_indices: typing.Annotated[
            collections.abc.Sequence[typing.SupportsInt | typing.SupportsIndex],
            "FixedSize(3)",
        ],
        compound_atom_indices: typing.Annotated[
            collections.abc.Sequence[typing.SupportsInt | typing.SupportsIndex],
            "FixedSize(3)",
        ],
        molecule_index: typing.SupportsInt | typing.SupportsIndex,
        stiffness_in_kj_per_rad_sq: typing.SupportsFloat | typing.SupportsIndex,
        nominal_angle_in_deg: typing.SupportsFloat | typing.SupportsIndex,
    ) -> None: ...
    @property
    def compound_atom_indices(
        self,
    ) -> typing.Annotated[list[CompoundAtomIndex], "FixedSize(3)"]: ...
    @compound_atom_indices.setter
    def compound_atom_indices(
        self,
        arg0: typing.Annotated[
            collections.abc.Sequence[CompoundAtomIndex], "FixedSize(3)"
        ],
    ) -> None: ...
    @property
    ...
    def stiffness_in_kj_per_rad_sq(
        self, arg0: typing.SupportsFloat | typing.SupportsIndex
    ) -> None: ...
...
class RoboAtomConnectivity:
    ...
    def __init__(
        self,
        neighbors_global_indices: collections.abc.Sequence[
...
class RoboAtomElement:
    ...
    def __init__(
        ...
        element_name: str,
        element_symbol: str,
        atomic_number: typing.SupportsInt | typing.SupportsIndex,
    ) -> None: ...
    @property
...
class RoboAtomIdentity:
    ...
    def __init__(
        ...
        atom_class_name: str,
        charged_atom_type_name: str,
        global_index: typing.SupportsInt | typing.SupportsIndex,
        prmtop_index: typing.SupportsInt | typing.SupportsIndex,
        molecule_index: typing.SupportsInt | typing.SupportsIndex,
        residue_index: typing.SupportsInt | typing.SupportsIndex,
        nonbonded_index: typing.SupportsInt | typing.SupportsIndex,
        compound_atom_index: typing.SupportsInt | typing.SupportsIndex,
        atom_class_index: typing.SupportsInt | typing.SupportsIndex,
        charged_atom_type_index: typing.SupportsInt | typing.SupportsIndex,
    ) -> None: ...
    @property
...
class RoboAtomPhysics:
    def __init__(
        self,
        charge_e: typing.SupportsFloat | typing.SupportsIndex,
        mass_daltons: typing.SupportsFloat | typing.SupportsIndex,
        vdw_radius_nm: typing.SupportsFloat | typing.SupportsIndex,
        vdw_well_depth_kj: typing.SupportsFloat | typing.SupportsIndex,
        sigma_nm: typing.SupportsFloat | typing.SupportsIndex,
        solvent_radius_nm: typing.SupportsFloat | typing.SupportsIndex,
        screen: typing.SupportsFloat | typing.SupportsIndex,
    ) -> None: ...
    @property
...
class RoboBond:
    ...
    def __init__(
        ...
        stiffness_in_kj_per_nm_sq: typing.SupportsFloat | typing.SupportsIndex,
        nominal_length_in_nm: typing.SupportsFloat | typing.SupportsIndex,
        molecule_index: typing.SupportsInt | typing.SupportsIndex,
        ring_closing: bool,
        dihedral_type: str,
    ) -> None: ...
    ...
    def compound_atom_indices(
        self,
    ) -> typing.Annotated[list[CompoundAtomIndex], "FixedSize(2)"]: ...
    @compound_atom_indices.setter
    def compound_atom_indices(
        self,
        arg0: typing.Annotated[
            collections.abc.Sequence[CompoundAtomIndex], "FixedSize(2)"
        ],
    ) -> None: ...
    @property
...
class RoboHarmonicImproperTorsion:
    def __init__(
        ...
        molecule_index: typing.SupportsInt | typing.SupportsIndex,
        stiffness_in_kj_per_rad_sq: typing.SupportsFloat | typing.SupportsIndex,
        nominal_angle_in_rad: typing.SupportsFloat | typing.SupportsIndex,
    ) -> None: ...
    @property
    def compound_atom_indices(
        self,
    ) -> typing.Annotated[list[CompoundAtomIndex], "FixedSize(4)"]: ...
    @compound_atom_indices.setter
    def compound_atom_indices(
        self,
        arg0: typing.Annotated[
            collections.abc.Sequence[CompoundAtomIndex], "FixedSize(4)"
        ],
    ) -> None: ...
    @property
...
class RoboPeriodicTorsion:
    ...
    def __init__(
        ...
        molecule_index: typing.SupportsInt | typing.SupportsIndex,
        improper: bool,
        terms: collections.abc.Sequence[RoboPeriodicTorsionTerm],
    ) -> None: ...
    @property
    def compound_atom_indices(
        self,
    ...
    def terms(
        self,
    ) -> typing.Annotated[list[RoboPeriodicTorsionTerm], "FixedSize(5)"]: ...
    @terms.setter
    def terms(
        self,
        arg0: typing.Annotated[
            collections.abc.Sequence[RoboPeriodicTorsionTerm], "FixedSize(5)"
        ],
    ) -> None: ...
...
class RoboPeriodicTorsionTerm:
    def __init__(
        self,
        amplitude_kj: typing.SupportsFloat | typing.SupportsIndex,
        phase_deg: typing.SupportsFloat | typing.SupportsIndex,
        periodicity: typing.SupportsInt | typing.SupportsIndex,
    ) -> None: ...
    @property
...
class RootMobility:
    ...
    __members__: typing.ClassVar[
        dict[str, RootMobility]
    ]  # value = {'FREE': <RootMobility.FREE: 0>, 'CARTESIAN': <RootMobility.CARTESIAN: 1>, 'WELD': <RootMobility.WELD: 2>, 'FREE_LINE': <RootMobility.FREE_LINE: 3>, 'BALL': <RootMobility.BALL: 4>, 'PIN': <RootMobility.PIN: 5>}
    @typing.overload
...
class RunType:
    ...
    __members__: typing.ClassVar[
        dict[str, RunType]
    ]  # value = {'DEFAULT': <RunType.DEFAULT: 0>, 'REMC': <RunType.REMC: 1>, 'RENEMC': <RunType.RENEMC: 2>, 'RENE': <RunType.RENE: 3>}
    @typing.overload
...
class SamplerName:
    ...
    __members__: typing.ClassVar[
        dict[str, SamplerName]
    ]  # value = {'EMPTY': <SamplerName.EMPTY: 0>, 'MC': <SamplerName.MC: 1>, 'HMC': <SamplerName.HMC: 2>, 'LAHMC': <SamplerName.LAHMC: 3>}
    @typing.overload
...
class Scaling14:
    ...
    def __init__(
        self,
        a1: typing.SupportsInt | typing.SupportsIndex,
        a4: typing.SupportsInt | typing.SupportsIndex,
        charge_product: typing.SupportsFloat | typing.SupportsIndex,
        epsilon: typing.SupportsFloat | typing.SupportsIndex,
        sigma: typing.SupportsFloat | typing.SupportsIndex,
    ) -> None: ...
    @property
    def a1(self) -> int: ...
    @a1.setter
...
class ThermostatName:
    ...
    NOSE_HOOVER: typing.ClassVar[
        ThermostatName
    ]  # value = <ThermostatName.NOSE_HOOVER: 4>
    __members__: typing.ClassVar[
        dict[str, ThermostatName]
    ]  # value = {'NONE': <ThermostatName.NONE: 0>, 'ANDERSEN': <ThermostatName.ANDERSEN: 1>, 'BERENDSEN': <ThermostatName.BERENDSEN: 2>, 'LANGEVIN': <ThermostatName.LANGEVIN: 3>, 'NOSE_HOOVER': <ThermostatName.NOSE_HOOVER: 4>}
    @typing.overload
...
class TopologyRange:
    def __init__(
        self,
        startCounts: collections.abc.Sequence[
            typing.SupportsInt | typing.SupportsIndex
        ],
    ) -> None: ...
    def close(
        self,
        endCounts: collections.abc.Sequence[typing.SupportsInt | typing.SupportsIndex],
    ) -> None: ...
...
class TopologyRangeType:
    ...
    IMPROPER_HARMONIC_TORSION: typing.ClassVar[
        TopologyRangeType
    ]  # value = <TopologyRangeType.IMPROPER_HARMONIC_TORSION: 4>
    PERIODIC_TORSION: typing.ClassVar[
        TopologyRangeType
    ]  # value = <TopologyRangeType.PERIODIC_TORSION: 3>
    __members__: typing.ClassVar[
        dict[str, TopologyRangeType]
    ]  # value = {'EMPTY': <TopologyRangeType.EMPTY: 0>, 'BOND': <TopologyRangeType.BOND: 1>, 'ANGLE': <TopologyRangeType.ANGLE: 2>, 'PERIODIC_TORSION': <TopologyRangeType.PERIODIC_TORSION: 3>, 'IMPROPER_HARMONIC_TORSION': <TopologyRangeType.IMPROPER_HARMONIC_TORSION: 4>}
    @typing.overload
...
class World:
    def addSampler(
        self, arg0: SamplerName, arg1: IntegratorType, arg2: ThermostatName, arg3: bool
    ) -> bool:
        """
    ...
    def has_rigid_body_violations(
        self,
        timeStep: typing.SupportsFloat | typing.SupportsIndex,
        numSteps: typing.SupportsInt | typing.SupportsIndex,
    ) -> bool:
        """
...
def align_flip_and_translate_frame_along_x_axis(
...
def calculate_angle_in_rad(
    arg0: typing.Annotated[numpy.typing.ArrayLike, numpy.float64],
    arg1: typing.Annotated[numpy.typing.ArrayLike, numpy.float64],
    arg2: typing.Annotated[numpy.typing.ArrayLike, numpy.float64],
) -> float: ...
def calculate_dihedral_in_rad(
    arg0: typing.Annotated[numpy.typing.ArrayLike, numpy.float64],
    arg1: typing.Annotated[numpy.typing.ArrayLike, numpy.float64],
    arg2: typing.Annotated[numpy.typing.ArrayLike, numpy.float64],
    arg3: typing.Annotated[numpy.typing.ArrayLike, numpy.float64],
) -> float: ...
def calculate_log_sum_exp2(
    arg0: typing.SupportsFloat | typing.SupportsIndex,
    arg1: typing.SupportsFloat | typing.SupportsIndex,
) -> float: ...
def calculate_mag_sq(
    arg0: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex],
) -> float: ...
def chirality_from_plane_deviation(
    arg0: typing.SupportsFloat | typing.SupportsIndex,
) -> BondCenterChirality: ...
def exceeds_planarity_threshold(
    arg0: typing.SupportsFloat | typing.SupportsIndex,
    arg1: typing.SupportsFloat | typing.SupportsIndex,
) -> bool: ...
...
def is_bond_chirality_mismatch(
    ...
    arg1: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)],
    arg2: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)],
    arg3: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)],
    arg4: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)],
    arg5: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)],
) -> bool: ...
def is_chirality_mismatch(
    arg0: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)],
    arg1: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)],
    arg2: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)],
    arg3: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)],
