"""Per-body force monitoring for 7JJO (turkey beta1-AR) WITHOUT agonist (apo), in a nanodisc.
...
Run from the repo root:
    python3 python/robosample/run_7JJO.nolig.py
"""
...
NAME = "7JJO.noLig"
PRMTOP = "examples/febs/7JJO.noLig.nanodisc.prmtop"
INPCRD = "examples/febs/7JJO.noLig.nanodisc.min.rst7"
