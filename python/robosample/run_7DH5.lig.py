"""Per-body force monitoring for 7DH5 (dog beta3-AR) WITH agonist (mirabegron), in a nanodisc.
...
Run from the repo root:
    python3 python/robosample/run_7DH5.lig.py
"""
...
NAME = "7DH5.lig"
PRMTOP = "examples/febs/7DH5.lig.nanodisc.prmtop"
INPCRD = "examples/febs/7DH5.lig.nanodisc.min.rst7"
