...
void World::setFlexibilities(const std::vector<BondFlexibility>& flexibilities)
{
	this->flexibilities = flexibilities;
}

const std::vector<BondFlexibility>& World::getFlexibilities() const
{
