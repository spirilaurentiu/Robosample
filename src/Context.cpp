...
void Context::PrintSamplerDataToLog(std::size_t whichWorld, std::size_t whichSampler)
{
	...
	fprintf(logFile, "%f %d %d %d %.2f %.2f %.2f %.2f %.12f %.12f %.12f "
		...
		, worlds[whichWorld].updSampler(whichSampler)->getAcceptedSteps()
		, worlds[whichWorld].updSampler(whichSampler)->getOldPE()
		, worlds[whichWorld].updSampler(whichSampler)->getSetPE()
		, worlds[whichWorld].updSampler(whichSampler)->getOldKE()
		, worlds[whichWorld].updSampler(whichSampler)->getNewKE()
		, worlds[whichWorld].updSampler(whichSampler)->getOldFixman()
		, worlds[whichWorld].updSampler(whichSampler)->getNewFixman()
		, worlds[whichWorld].updSampler(whichSampler)->getSetFixman()
	);
	fflush(logFile);
...
void Context::PrintDistancesToLog(std::size_t whichWorld, std::size_t whichSampler)
{
	for (const auto& distanceIx : distanceIxs) {
		if( distanceIx[0] == static_cast<int>(whichWorld)){
			fprintf(logFile, "%.6f ", Distance(distanceIx[0], distanceIx[1], whichSampler,
...
void Context::PrintAnglesToLog(std::size_t whichWorld, std::size_t whichSampler)
{
	for (const auto& angleIx : angleIxs){
		if( angleIx[0] == static_cast<int>(whichWorld)){
			fprintf(logFile, "%.6f ", Roboangle(angleIx[0], angleIx[1], whichSampler,
...
void Context::PrintDihedralsToLog(std::size_t whichWorld, std::size_t whichSampler)
{
	for (const auto& dihedralIx : dihedralIxs){
		if( dihedralIx[0] == static_cast<int>(whichWorld)){
			fprintf(logFile, "%.6f ", Dihedral(dihedralIx[0], dihedralIx[1], whichSampler,
