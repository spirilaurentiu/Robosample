...
PYBIND11_MODULE(MODULE_NAME, m) {
    ...
    py::class_<Context>(m, "Context")
        ...
        .def("setThermoStateTemperature", &Context::setThermoStateTemperature, "Set the temperature of a thermodynamic state.")
        .def("prepareREX", &Context::prepareREX, "Prepare replica exchange.")
