...
// static_assert(std::is_base_of<SimTK::MultibodySystem, UR10>::value &&
//               std::is_base_of<SimTK::MultibodySystem, CompoundSystem>::value,
//               "Both classes must derive from the same base class!");
